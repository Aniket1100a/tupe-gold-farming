  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300 group flex flex-col h-full">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-xl font-bold text-gray-900 mb-2">{product.name[language] || product.name['en']}</h3>
        <p className="text-gray-600 text-sm mb-6 flex-grow">{product.shortDescription[language] || product.shortDescription['en']}</p>
